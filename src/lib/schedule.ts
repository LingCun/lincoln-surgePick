...
export const CATEGORY_DESC: Record<string, string> = {
  ...
  macro: '거시경제 지표 발표. 시장 컨센서스 대비 서프라이즈가 주가·환율·금리에 즉각 반영됩니다. 동일 지표라도 발표 시점의 시장 기대치에 따라 같은 수치가 다르게 해석될 수 있어요.',
  earnings: '기업 분기 실적 발표. EPS·매출 컨센서스 충족 여부보다 가이던스(향후 전망)와 컨퍼런스콜 톤이 더 중요. 실적 직전/직후 옵션 IV 급변에 유의.',
